...
const PowerPlatformCampaign = () => {
  ...
  const fetchCampaigns = async (page = currentPage, limit = itemsPerPage) => {
    ...
    try {
      const token = Cookies.get('token');
      const response = await axios.post(`${BASE_API_URL}/pri/campagin/power-platform`, {
        year: searchYear,
        ...
        <div className="col-sm-12">
          <div className="card">
            <div className="card-body">
              <h4>Power Platform Campaigns</h4>
...
export default PowerPlatformCampaign;