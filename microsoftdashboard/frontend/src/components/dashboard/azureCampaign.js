...
const AzureCampaign = () => {
  ...
  const fetchCampaigns = async (page = currentPage, limit = itemsPerPage) => {
    ...
    try {
      const token = Cookies.get('token');
      const response = await axios.post(`${BASE_API_URL}/pri/campagin/azure`, {
        year: searchYear,
  ...
  const handleStatusChangeCampaign = async (campaignId, newStatus) => {
    try {
      ...
      toast.error("Status not upddated")
        ...
        <div className="col-sm-12">
          <div className="card">
            <div className="card-body">
              <h4>Azure Campaigns</h4>
              <div className="d-flex mb-3 mt-5">
                <select className="form-select minimal" value={searchYear} onChange={handleYearChange}>
                ...
                <select className="form-select minimal ms-2" value={searchStatus} onChange={handleStatusChange}>
                  ...
                  <option value="Hosted Content">Hosted Content</option>
                  <option value="Changed Approved">Changed Approved</option>
